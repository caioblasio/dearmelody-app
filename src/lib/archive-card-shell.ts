...
export const ARCHIVE_CARD_SHELL_GEOMETRY =
  'flex w-full flex-col rounded-2xl p-4 lg:rounded-3xl lg:p-8'
...
export const ARCHIVE_CARD_SHELL_NEUTRAL =
  'border border-black/5 bg-surface-container-lowest shadow-sm lg:shadow-md hover:shadow-xl motion-safe:transition-[box-shadow]'
